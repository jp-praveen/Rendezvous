...
for i=1:5;
    ...
    j=0;
    for twait=1:500:T(1);                                   % Waiting Time
        j=j+1;
        r1_ini=r_chaser_1;
        v1_ini=v_chaser_1;
        ...
        for dt=50:100:1000;
            ...
            ma_deg=(u^2/h(1,i+1)^3)*(1-e(1,i+1)^2)^(1.5)*(t_initial(1,i)+t);
            ...
            if dv_prograde_1<dv_max || dv_retrograde_1<dv_max;
                ...
                if dv_prograde_1>dv_retrograde_1;
                    dv(i,j)=dv_retrograde_1;
                else 
                    dv(i,j)=dv_prograde_1;
                end
...
for i=1:5;
    ...
    dt(dt==0)=nan;
    figure(i);
    plot(coasting_time,dt);
    grid
    title('Coasting Period VS Tranfer time');
    xlabel('Coasting time (in seconds)');
    ylabel('Transfer time (in seconds)');  
    dt=[];
    coasting_time=[];
end
